...
def send_message_01(host: str, queue_name_01: str, message: str):
    ...
    try:
        ...
        #ch.queue_delete(queue=queue_name_01)
...
def prepare_message_from_row_01(row):
    ...
    if Channel1 == '':
        Channel1 = 'No temperature'
    first_message = Time, Channel1
    fstring_message_01 = ",".join(first_message)
...
def send_message_02(host: str, queue_name_02: str, message_02: str):
    ...
    try:
        ...
        # and help ensure messages are processed in order
        # messages will not be deleted until the consumer acknowledges
        #ch.queue_delete(queue=queue_name_02)
...
def prepare_message_from_row_02(row):
    ...
    # notice the f before the opening quote for our string?
    if Channel2 == '':
        Channel2 = 'No temperature'
    second_message = Time, Channel2
    fstring_message_02 = ",".join(second_message)
...
def send_message_03(host: str, queue_name_03: str, message_03: str):
    ...
    try:
        ...
        # and help ensure messages are processed in order
        # messages will not be deleted until the consumer acknowledges
        #ch.queue_delete(queue=queue_name_03)
...
def prepare_message_from_row_03(row):
    ...
    if Channel3 == '':
        Channel3 = 'No temperature'
    third_message = Time, Channel3
    fstring_message_03 = ",".join(third_message)
